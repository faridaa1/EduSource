...
console.log(import.meta.env.BASE_URL, import.meta.env.BASE_URL === 'development')
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/sold-orders', name: 'sold orders', component: Orders },
    { path: '/orders/:catchAll(.*)', name: 'back orders', component: Orders },
    { path: '/sold-orders/:catchAll(.*)', name: 'sold back orders', component: Orders },
    { path: '/order/:catchAll(.*)', name: 'order', component: Order },
    { path: '/sold-order/:catchAll(.*)', name: 'sold order', component: Order },
    { path: '/return/:catchAll(.*)', name: 'return', component: Return },
    { path: '/sold-return/:catchAll(.*)', name: 'sold return', component: Return },
