  ...
  <div id="app-vue" v-if="complete">
    <div id="light">
      ...
      <header id="main-header">
        <img id='logo' src="/src/assets/logo-light.svg" alt="EduSource" width="125" height="125" v-pre/>
        ...
        nextTick(() => {
          ...
          if (div) {
            ...
            if (theme) {
                ...
                if (logo) {
                    logo.src = theme.id === 'light' ? '/src/assets/logo-light.svg' : '/src/assets/logo-dark.svg'
                }
            }
          }
        })
