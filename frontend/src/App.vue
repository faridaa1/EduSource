  ...
  <div id="app-vue" v-if="complete">
    <div id="light">
      ...
      <header id="main-header">
        <img id='logo' src="../../static/api/logo-light.svg" alt="EduSource" width="125" height="125" v-pre/>
        ...
        nextTick(() => {
          ...
          if (div) {
            ...
            if (theme) {
                ...
                if (logo) {
                    logo.src = theme.id === 'light' ? '../../static/api/logo-light.svg' : '../../static/api/logo-dark.svg'
                }
            }
          }
        })
